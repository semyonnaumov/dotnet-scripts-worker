...
public interface ContainerizedJobsPool {
    ...
    /**
     * Tries to create a new entry in the containerized job pool for {@code timeoutSec}.
     * If failed to allocate during {@code timeoutSec}, throws an exception.
     ...
     * @param timeoutSec timeout for allocation
     ...
     */
    ContainerizedJob tryAllocate(UUID jobId, int timeoutSec) throws ContainerizedJobAllocationException;
